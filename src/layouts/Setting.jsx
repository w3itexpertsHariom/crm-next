  ...
  return (
	<>
		<div className={`sidebar-right ${settingToggle ? "show" : ""}`}>
			...
			<Link href="#" scroll={false} className="sidebar-right-trigger wave-effect wave-effect-x" onClick={() => setSettingToggle(!settingToggle)} >
				<span><i className="fa fa-cog fa-spin" /></span>
			</Link>
			<Link href="#" scroll={false} className="sidebar-close-trigger" onClick={() => setSettingToggle(!settingToggle)} >
			...
			<div className="sidebar-right-inner">
				...
				<div className="note-text">
					<span className="text-danger">*Note :</span> This theme switcher is not part of product. It is only for demo. you will get all guideline in documentation. please check <a href="https://w3crm.dexignzone.com/next/doc" rel="noreferrer" target="_blank" className="text-primary">documentation.</a>
				</div>				
			</div>
		</div>
