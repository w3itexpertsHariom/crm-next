                                          ...
                                          <div className="task-card-data">
                                              ...
                                              {index % 2 === 0 ?
                                                <div className="avatar-list avatar-list-stacked my-2">
                                                    <Image src={IMAGES.contact6} className="avatar rounded-circle" alt="avar1"/>{" "}
                                                    <Image src={IMAGES.contact5} className="avatar rounded-circle" alt="avat2"/>{" "}
                                                    <Image src={IMAGES.contact1} className="avatar rounded-circle" alt="avat3"/>{" "}
                                                    <Image src={IMAGES.contact2} className="avatar rounded-circle" alt="ava4"/>{" "}
                                                    <Image src={IMAGES.contact5} className="avatar rounded-circle" alt="ava5"/>
                                                </div>
                                                :
