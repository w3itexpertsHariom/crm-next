    ...
    return(
        <div className="row">
            ...
            <div className="d-flex align-items-center">
                <Link href={"#"} scroll={false} className="text-danger">Remove</Link><span className="mx-2">|</span>
                <Link href={"#"} scroll={false}>Cancel</Link>
            </div>
        </div>	
    )
}
...
const MenuAccordBlog2 = () =>{
    return(
        <div className="row">
            ...
            <div className="col-xl-12">
                <p className="dlab-terms">Original: <Link href={"#"} scroll={false}>Terms and Conditions</Link></p>
            </div>
            <div className="d-flex align-items-center">
                <Link href={"#"} scroll={false} className="text-danger">Remove</Link><span className="mx-2">|</span>
                <Link href={"#"} scroll={false}>Cancel</Link>
