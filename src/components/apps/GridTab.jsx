                        ...
                        <div className="card">
                            <div className="card-body">
                                <div className="card-use-box">
                                    ...
                                    <div>
                                        <Link href="#" scroll={false} className="btn btn-primary btn-sm me-2">Message</Link>{" "}
                                        <Link href="#" scroll={false} className="btn btn-secondary btn-sm ms-2" >Following</Link>
                                    </div>	
                                </div>
                            </div>
                        </div>
