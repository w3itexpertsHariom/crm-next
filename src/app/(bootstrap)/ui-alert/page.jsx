...
import {reducer} from '@/components/bootstrap/alert/alertReducer';
import AlertList from '@/components/bootstrap/alert/AlertList';
...
const UiAlert = () => {
  ...
  return (
                                ...
                                <Tab.Pane eventKey="Preview">
                                  <Card.Body>
                                      <Alert  variant="primary" dismissible show={state.linkprimary}>               
                                          ...
                                          <Link href="#" scroll={false}>Please check this one as well. <button className="btn-close" onClick={()=>dispatch({type:'linkprimary'})}><span><i className="fa-solid fa-xmark"></i></span></button></Link>
                                      </Alert>
                                      <Alert  variant="secondary" dismissible show={state.linksecondary}>               
                                          <strong>WOW! Eveything looks OK. </strong>
                                          <Link href="#" scroll={false}>Please check this one as well. <button className="btn-close" onClick={()=>dispatch({type:'linksecondary'})}><span><i className="fa-solid fa-xmark"></i></span></button></Link>
                                      </Alert>
                                      <Alert  variant="success" dismissible show={state.linksuccess}>               
                                          <strong>WOW! Eveything looks OK. </strong>
                                          <Link href="#" scroll={false}>Please check this one as well. <button className="btn-close" onClick={()=>dispatch({type:'linksuccess'})}><span><i className="fa-solid fa-xmark"></i></span></button></Link>
                                      </Alert>
                                      <Alert  variant="info" dismissible show={state.linkinfo}>               
                                          <strong>WOW! Eveything looks OK. </strong>
                                          <Link href="#" scroll={false}>My birthday party <button className="btn-close" onClick={()=>dispatch({type:'linkinfo'})}><span><i className="fa-solid fa-xmark"></i></span></button></Link>
                                      </Alert>
                                      <Alert  variant="warning" dismissible show={state.linkwarning}>               
                                          <strong>WOW! Eveything looks OK. </strong>
                                          <Link href="#" scroll={false}>Check this out <button className="btn-close" onClick={()=>dispatch({type:'linkwarning'})}><span><i className="fa-solid fa-xmark"></i></span></button></Link>
                                      </Alert>
                                      <Alert  variant="danger" dismissible show={state.linkdanger}>               
                                          <strong>WOW! Eveything looks OK. </strong>
                                          <Link href="#" scroll={false}>Click here for details. <button className="btn-close" onClick={()=>dispatch({type:'linkdanger'})}><span><i className="fa-solid fa-xmark"></i></span></button></Link>
                                      </Alert>
                                      <Alert  variant="dark" dismissible show={state.linkdark}>               
                                          <strong>WOW! Eveything looks OK. </strong>
                                          <Link href="#" scroll={false}>Click here for details. <button className="btn-close" onClick={()=>dispatch({type:'linkdark'})}><span><i className="fa-solid fa-xmark"></i></span></button></Link>
                                      </Alert>
                                      <Alert  variant="light" dismissible show={state.linklight}>               
                                          <strong>WOW! Eveything looks OK. </strong>
                                          <Link href="#" scroll={false}>Click here for details. <button className="btn-close" onClick={()=>dispatch({type:'linklight'})}><span><i className="fa-solid fa-xmark"></i></span></button></Link>
                                      </Alert>
                                ...
                                <Tab.Pane eventKey="Preview">
                                  <Card.Body> 
                                      <Alert  variant="primary" dismissible show={state.linkprimary} className='solid'>               
                                          ...
                                          <Link href="#" scroll={false} className='badge badge-sm light badge-primary ms-1'>upgrade</Link>     
                                      ...
                                      <Alert  variant="secondary" dismissible show={state.linksecondary} className='solid'>               
                                          <strong>WOW!</strong> Eveything looks OK. 
                                          <Link href="#" scroll={false} className='badge-sm light ms-1 badge badge-secondary'>upgrade</Link>   
                                      ...
                                      <Alert  variant="success" dismissible show={state.linksuccess} className='solid'>               
                                          <strong>WOW!</strong> Eveything looks OK. 
                                          <Link href="#" scroll={false} className='badge badge-sm light badge-success ms-1'>upgrade</Link>   
                                      ...
                                      <Alert  variant="info" dismissible show={state.linkinfo} className='solid'>               
                                          ...
                                          <Link href="#" scroll={false} className='badge-sm light ms-1 badge badge-info'>upgrade</Link>   
                                      ...
                                      <Alert  variant="warning" dismissible show={state.linkwarning} className='solid'>               
                                          ...
                                          <Link href="#" scroll={false} className='badge-sm light ms-1 badge badge-warning'>upgrade</Link>   
                                      ...
                                      <Alert  variant="danger" dismissible show={state.linkdanger} className='solid'>               
                                          ...
                                          <Link href="#" scroll={false} className='badge-sm light ms-1 badge badge-danger'>upgrade</Link>   
                                      ...
                                      <Alert  variant="dark" dismissible show={state.linkdark} className='solid'>               
                                          <strong>Error!</strong>Something Went wrong.
                                          <Link href="#" scroll={false} className='badge-sm light ms-1 badge badge-dark'>upgrade</Link>   
                                      ...
                                      <Alert  variant="light" dismissible show={state.linklight} className='solid'>               
                                          <strong>Error!</strong>Something Went wrong.
                                          <Link href="#" scroll={false} className='badge-sm light ms-1 badge badge-light'>upgrade</Link>   
    ...
    <Alert  variant="success" dismissible show={state.linksuccess} className='solid'>               
      <strong>WOW! Eveything looks OK. </strong>
      <Link href="#" scroll={false} className='badge-sm light ms-1 badge badge-succes'>upgrade</Link>   
      <button className="btn-close" onClick={()=>dispatch({type:'linksuccess'})}><span><i className="fa-solid fa-xmark"></i></span></button>
    </Alert>
    <Alert  variant="info" dismissible show={state.linkinfo} className='solid'>               
      <strong>WOW! Eveything looks OK. </strong>
