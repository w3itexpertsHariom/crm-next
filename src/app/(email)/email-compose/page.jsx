...
import DropFile from "@/components/email/DropFile";
									...
									<div className="col-xl-2 col-xxl-3 col-lg-3">
										<div className="email-left-box dz-scroll pt-3 ps-0">
											...
											<div className="mail-list rounded ">
												<Link href="/email-inbox" className="list-group-item active">
												...
												<Link href="/email-compose" className="list-group-item">
												...
												<Link href="#" scroll={false} className="list-group-item"><i className="fa-regular fa-clock align-middle"></i> Scheduled</Link>
												<Link href="#" scroll={false} className="list-group-item ">
											...
											<div className="mail-list rounded overflow-hidden mt-4 ">
												...
												<Link href="/email-inbox" className="list-group-item change">Work </Link>
												<Link href="/email-inbox" className="list-group-item change">Private </Link>
												<Link href="/email-inbox" className="list-group-item change">Support</Link>
												<Link href="/email-inbox" className="list-group-item change">Social</Link>
											</div>
										</div>
									</div>
