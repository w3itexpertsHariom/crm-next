...
import DonutChart from "@/components/widget/DonutChart";
import ActiveUser from "@/components/widget/ActiveUser";
import AllSell1 from "@/components/widget/AllSell1";
import AllSell2 from "@/components/widget/AllSell2";
import BloodPressur from "@/components/widget/BloodPressure";
import Clolesterol from "@/components/widget/Clolesterol";
import GlucoseRate from "@/components/widget/GlucoseRate";
import FeeCollection from "@/components/widget/FeeCollection";
import HeartRate from "@/components/widget/HeartRate";
import LifeTimeEarning from "@/components/widget/LifeTimeEarning";
import MarketNow from "@/components/widget/MarketNow";
import NewStudent from "@/components/widget/NewStudent";
import PowerBar from "@/components/widget/PowerBar";
import PowerLine from "@/components/widget/PowerLine";
import SalesAnalysis from "@/components/widget/SalesAnalysis";
import TopProducts1 from "@/components/widget/TopProducts1";
import TopProducts2 from "@/components/widget/TopProducts2";
import TotalCourse from "@/components/widget/TotalCourse";
import TotalStudent from "@/components/widget/TotalStudent";
import ViewProject from "@/components/widget/ViewProject";
import VisitorActivity from "@/components/widget/VisitorActivity";
import WeeklySales1 from "@/components/widget/WeeklySales1";
import WeeklySales2 from "@/components/widget/WeeklySales2";
                    ...
                    <li>
                      <div className="timeline-panel">
                        <div className="media me-2">
                          <Image  alt="" width="50" src={avatar1} />
                        </div>
                ...
                >
                  <ul className="timeline">
                    ...
                    <li>
                      <div className="timeline-panel">
                        <div className="media me-2 media-success">
                          <Image  alt="" width="50" src={avatar2} />
                        </div>
                        <div className="media-body">
                          <h5 className="mb-1">
                            Jack Ronan{" "}
                    ...
                    <li>
                      <div className="timeline-panel">
                        <div className="media me-2 media-primary">
                          <Image  alt="" width="50" src={avatar3} />
                        </div>
                        <div className="media-body">
                          <h5 className="mb-1">
                            Oscar Weston{" "}
          ...
          <div className="col-xl-4 col-lg-12 col-xxl-4 col-sm-12">
            <div className="card">
              <div className="card-body text-center ai-icon  text-primary">
                ...
                <Link href="#" scroll={false} className="btn my-2 btn-primary btn-lg px-4">
                ...
                <div className="widget-media">
                  <ul className="timeline">
                    <li>
                      <div className="timeline-panel">
                        <div className="media me-2">
                          <Image  alt="" width="50" src={avatar4} />
                        </div>
                        <div className="media-body">
                          <h5 className="mb-1">Dr sultads Send you Photo</h5>
                          <small className="d-block">
                    ...
                    <li>
                      <div className="timeline-panel">
                        <div className="media me-2 media-info">
                          <Image  width="50" alt="" src={avatar2} />
                        </div>
                        <div className="media-body">
                          <h5 className="mb-1">Resport created successfully</h5>
                          <small className="d-block">
                    ...
                    <li>
                      <div className="timeline-panel">
                        <div className="media me-2 media-success">
                          <Image  width="50" alt="" src={avatar3} />
                        </div>
                        <div className="media-body">
                          <h5 className="mb-1">Reminder : Treatment Time!</h5>
                          <small className="d-block">
