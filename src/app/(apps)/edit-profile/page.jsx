                            ...
                            <div className="card card-bx profile-card author-profile m-b30">
                                <div className="card-body">
                                    <div className="p-5">
                                        <div className="author-profile">
                                            <div className="author-media">
                                                <Image src={IMAGES.Tab1} alt="pro" width={130}/>
                                    ...
                                    <div className="info-list">
                                        <ul>
                                            <li><Link href={"/app-profile"}>Models</Link><span>36</span></li>
                                            <li><Link href={"/uc-lightgallery"}>Gallery</Link><span>3</span></li>
                                            <li><Link href={"/app-profile"}>Lessons</Link><span>1</span></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div className="card profile-card card-bx m-b30">
                            ...
                            <form className="profile-form">
                                ...
                                <div className="card-footer">
                                    ...
                                    <Link href={"#"} scroll={false} className="btn-link">Forgot your password?</Link>
                                </div>
                            </form>
                        </div>
                    </div>
