                        ...
                        <div className="card h-auto">
                            <div className="card-body">
                                <div className="c-profile text-center">
                                    <Image src={IMAGES.User} className="rounded-circle mb-2" alt="" />
                                ...
                                <div className="d-flex mt-4 justify-content-end">
                                    <Link href={"#"} scroll={false} className="btn btn-danger btn-sm light me-2">
                        ...
                        <div className="card h-auto">
                            <div className="card-body d-flex align-items-center justify-content-between flex-wrap">
                                <div className="d-flex align-items-center c-busiess">
                                    <Image src={IMAGES.Econimics} className="avatar" alt="" />
                                    <div>
                                ...
                                <div>
                                    <Link href={"#"} scroll={false} className="btn btn-danger btn-sm me-2">Cancel plan</Link>
                                    <Link href={"#"} scroll={false} className="btn btn-primary btn-sm ms-2">Update plan</Link>
                                </div>
                            </div>
                        </div>
                        <div className="card h-auto">
                            ...
                            <div className="card-body pt-0">
                                <div className="row">
                                    <div className="col-xl-4 col-lg-4">
                                        <Image src={IMAGES.Credit} alt="" style={{ height: "200px", width: '300px' }} />
                                    </div>
