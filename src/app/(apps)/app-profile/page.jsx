					...
					<div className="profile card card-body px-3 pt-3 pb-0">
						...
						<div className="profile-info">
							<div className="profile-photo">
								<Image src={profile} className="img-fluid rounded-circle" alt="profile"/>
							</div>
									...
									<div className="card-body">
										<div className="profile-statistics">
											<div className="text-center">
												...
												<div className="mt-4">
													<Link href="/post-details" className="btn btn-primary mb-1 me-1">Follow</Link>
													<Link href={"#"} scroll={false} className="btn btn-primary mb-1 ms-1" onClick={() => dispatch({type:'sendMessage'})}>Send Message</Link>
												</div>
											</div>
								...
								<div className="card">
									...
									<div className="card-body pt-3"	>	
										<div className="profile-blog ">
											<Image  src={IMAGES.Profile1}  alt="profile" className="img-fluid  mb-4 w-100 " />
											<Link href="/post-details"> <h4>Darwin Creative Agency Theme</h4> </Link>
											<p className="mb-0">
										...
										<div className="profile-news">
											{mediaBlog.map((item, index)=>(
												<div className="media pt-3 pb-3" key={index}>
													<Image src={item.image} alt="" className="me-3 rounded" width="75" />
													<div className="media-body">
														<h6 className="m-b-5"><Link href="/post-details" className="text-black">Collection of textile samples</Link></h6>
										...
										<Tab.Content>
												...
												<div className="my-post-content pt-3">
													<div className="post-input">
														<textarea name="textarea" id="textarea" cols={30} rows={5} className="form-control bg-transparent" placeholder="Please type what you want...."defaultValue={""}/>
															<Link href="#" scroll={false} className="btn btn-primary light px-3 me-2"  onClick={() => dispatch({type:'linkModal'})}>
																<i className="fa fa-link m-0" />{" "}
															</Link>
														{/* Modal */}
														
														<Link href="#" scroll={false} className="btn btn-primary light px-3 me-1"  data-target="#cameraModal" onClick={() => dispatch({type:'cameraModal'})}>
															<i className="fa fa-camera m-0" />{" "}
														</Link>
														{/* Modal */}
														
														<Link href="#" scroll={false} className="btn btn-primary ms-1" data-target="#postModal" onClick={() => dispatch({type:'postModal'})}>Post</Link>
														{/* Modal */}
														
													</div>
				
													<div className="profile-uoloaded-post border-bottom-1 pb-5">
														<Image src={IMAGES.Profile8} alt="" className="img-fluid w-100 rounded" />
													...
													<div className="profile-uoloaded-post border-bottom-1 pb-5">
														<Image src={IMAGES.Profile9} alt="" className="img-fluid w-100 rounded" />
														<Link className="post-title" href="/post-details">
															<h3 className="text-black">Collection of textile samples lay spread</h3>
														</Link>
														<p>
											...
											<Tab.Pane id="about-me" eventKey='About'>
												...
												<div className="profile-skills mb-5">
													...
													<Link href="/app-profile" className="btn btn-primary light btn-xs mb-1 me-1"> Admin</Link>
													<Link href="/app-profile" className="btn btn-primary light btn-xs mb-1 me-1" > Dashboard</Link>
													<Link href="/app-profile" className="btn btn-primary light btn-xs mb-1 me-1">Photoshop</Link>
													<Link href="/app-profile" className="btn btn-primary light btn-xs mb-1 me-1">Bootstrap</Link>
													<Link href="/app-profile" className="btn btn-primary light btn-xs mb-1 me-1">Responsive</Link>
													<Link href="/app-profile" className="btn btn-primary light btn-xs mb-1 me-1">Crypto</Link>
												</div>
												<div className="profile-lang  mb-5">
													<h4 className="text-primary mb-2">Language</h4>
													<Link href="/app-profile" className="text-muted pe-3 f-s-16">
			  ...
			  <Modal show={state.post} className="modal fade" id="postModal" onHide={() => dispatch({type:'postModal'})} centered>
				<div className="modal-content">
					...
					<div className="modal-body">
						...
						<Link className="btn btn-primary btn-rounded mt-1" href="/app-profile">Post</Link>
					</div>
				</div>
			</Modal>
			 {/* Link Modal */}
			  <Modal show={state.link}  className="modal fade post-input" id="linkModal" onHide={() => dispatch({type:'linkModal'})} centered>
				<div className="modal-content">
					...
					<div className="modal-body">
						<Link className="btn-social me-1 facebook" href="/app-profile"><i className="fab fa-facebook-f" /></Link>
						<Link className="btn-social me-1 google-plus" href="/app-profile"> <i className="fab fa-google-plus-g" /></Link>
						<Link className="btn-social me-1 linkedin" href="/app-profile"><i className="fab fa-linkedin-in" /></Link>
						<Link className="btn-social me-1 instagram" href="/app-profile"> <i className="fab fa-instagram" /></Link>
						<Link className="btn-social me-1 twitter" href="/app-profile"><i className="fab fa-twitter" /></Link>
						<Link className="btn-social me-1 youtube" href="/app-profile"><i className="fab fa-youtube" /></Link>
						<Link className="btn-social whatsapp" href="/app-profile"><i className="fab fa-whatsapp" /></Link>
					</div>
				</div>
			</Modal>
			 {/* Camera Modal */}
