...
import JobManagementList from '@/components/apps/JobManagementList';
import JobRejectionsList from '@/components/apps/JobRejectionsList';
        ...
        <>
            ...
            <div className="container-fluid">
				<div className="row">
					<div className="d-flex align-items-center justify-content-between">
						...
						<Link href={"#"} scroll={false} className="btn btn-primary btn-sm mb-3" 
			...
			<Offcanvas className="offcanvas offcanvas-end customeoff" show={addRole} onHide={setAddRole} placement='end'>
				...
				<div className="offcanvas-body">
					...
					<div>
						<Link href={"#"} scroll={false} className="btn btn-primary btn-sm" >Submit</Link>{" "}
						<Link href={"#"} scroll={false} className="btn btn-light btn-sm" >Discard</Link>
					</div>
				</div>
			</Offcanvas>  
        </>
