                        ...
                        <div className="card card-profile">
							<div className="admin-user">
								<div className="img-wrraper">                              
									<div className="">
										<Image src={IMAGES.User} className="rounded-circle" alt="" />
                                    </div>
									<Link href={"/edit-profile"} className="icon-wrapper"><i className="fa-solid fa-pencil"></i></Link>
								</div>
								<div className="user-details">
									<div className="title">
										<Link href={"#"} scroll={false}><h4>Thomas Fleming</h4></Link>
									  	<h6>Web Designer</h6>
									</div>
									  <ul className="user-social-links">
										<li><Link href={"#"} scroll={false}><i className="fa-brands fa-facebook-f"></i></Link></li>
										<li><Link href={"#"} scroll={false}><i className="fa-brands fa-skype"></i></Link></li>
										<li><Link href={"#"} scroll={false}><i className="fa-brands fa-linkedin-in"></i></Link></li>
										<li><Link href={"#"} scroll={false}><i className="fa-brands fa-instagram"></i></Link></li>
										<li><Link href={"#"} scroll={false}><i className="fa fa-rss"></i></Link></li>
									  </ul>
												...
												<Accordion.Body id="collapseOne1" className="collapse show">												 
													<div className="about-me">
														<ul>
															...
															<div>
																<Link href={"#"} scroll={false} className="btn btn-block bg-facebook mb-2"><i className="fa-brands fa-facebook-f me-2"></i>Facebook</Link>
																<Link href={"#"} scroll={false} className="btn btn-block bg-whatsapp mb-2"><i className="fa-brands fa-whatsapp me-2"></i>WhatsApp</Link>
																<Link href={"#"} scroll={false} className="btn btn-block bg-facebook mb-2"><i className="fa-brands fa-skype me-2"></i>Skype</Link>
															</div>
														</ul>
													</div>													
														...
														>
															...
															{galleryBlog.map((item,index)=>(
																<div data-src={item.image.src} className="col-lg-4 col-xl-4 col-sm-4 col-6 int-col mb-1" key={index}>
																	<Image src={item.image}  alt="gallery" className='px-1 py-1 img-fluid rounded'/>
																</div>
															))}
														</LightGallery>	
													</div>
												...
												<Accordion.Body id="collapseOne6">													
													<div className="friend-list">
														{friends.map((item, ind)=>(
															<Image src={item.image} className="avatar avatar-md" alt=""  key={ind}/>
														))}															
													</div>													
												</Accordion.Body>
											</Accordion.Item>
											...
											<div className="card-body pt-0">
												<div className="row">
													<div className="col-xl-6">
														<div className="post-img">
															<Image src={item.halfimage1} className="me-3" alt="" />	
														</div>	
													</div>
													<div className="col-xl-6">
														<div className="post-img">
															<Image src={item.halfimage2} className="ms-3" alt="" />	
														</div>	
													</div>
												</div>
												<div className="post-see d-flex align-items-center mt-3">
	...
	return(
		<div className="card-header border-0">
			<div className="products">
				<Image src={IMAGES.User} className="avatar avatar-md rounded-circle" alt="" />
				<div>
					<h5 className="mb-0"><Link href={"#"} scroll={false} className="text-black">Thomas Fleming</Link></h5>
...
function  PostComment(){
	return(
		<ul className="post-comment d-flex mt-3">
			<li>
				<label className="me-3"><Link href={"#"} scroll={false}><i className="fa-regular fa-heart me-2"/>Like</Link></label>
			</li>
			<li>
				<label className="me-3"><Link href={"#"} scroll={false}><i className="fa-regular fa-message me-2"/>Comment</Link></label>
			</li>
			<li>
				<label className="me-3"><Link href={"#"} scroll={false}><i className="fa-solid fa-share me-2"/>Share</Link></label>	
			</li>
		</ul>
	)
}
