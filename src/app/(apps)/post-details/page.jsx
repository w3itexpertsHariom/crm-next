                    ...
                    <div className="card-body">
                      <div className="profile-statistics">
                        <div className="text-center">
                          ...
                          <div className="mt-4">
                            <Link	href="/post-details"	className="btn btn-primary mb-1 me-1" onClick={() => dispatch({type:'followOpen'})}>Follow</Link>     
                            <Link href={"#"} scroll={false} className="btn btn-primary mb-1 ms-1" onClick={() => dispatch({type:'sendMessageOpen'})}>Send Message</Link>
                          </div>
                        </div>
                        {/* send Modal */}
                  ...
                  <div className="card">
                    ...
                    <div className="card-body pt-3"	>	
                      <div className="profile-blog ">
                        <Image  src={profile01}  alt="profile" className="img-fluid  mb-4 w-100" />
                          ...
                          {mediaBlog.map((item, index)=>(
                            <div className="media pt-3 pb-3" key={index}>
                              ...
                              <div className="media-body">
                                <h5 className="m-b-5"><Link href="/post-details" className="text-black">Collection of textile samples</Link></h5>
              ...
              <div className="card">
                <div className="card-body">
                  <div className="post-details">
                    ...
                    <Image src={profile08} alt="" className="img-fluid mb-3 w-100 rounded" />
                    <p>
