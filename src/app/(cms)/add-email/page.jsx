            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="col-xl-12">
                        <Link href={"/email-template"} type="submit" className="btn btn-primary mb-3">List Email Template</Link>
                    </div>
                    <div className="col-xl-12">
                        <div className="filter cm-content-box box-primary">
                            <div className="content-title">
                                ...
                                <div className="tools">
                                    <Link href="#" scroll={false} className={`SlideToolHeader ${collapseBtn ? 'collapse' : 'expand' }`}
