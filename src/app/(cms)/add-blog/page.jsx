                    ...
                    <div className="col-xl-12">                    
                        <div className="mb-5">
                            <ul className="d-flex align-items-center flex-wrap">
                                <li><Link href={"/blog"} className="btn btn-primary">Blog List</Link></li>
                                <li><Link href={"/blog-category"} className="btn btn-primary mx-1">Blog Category</Link></li>
                                <li><Link href={"/blog-category"} className="btn btn-primary me-1 mt-sm-0 mt-1">Add Blog Category</Link></li>
                                <li>
                                    <Link href={"#"} className="btn btn-primary open mt-1 mt-md-0"
                                        ...
                                        <Collapse in={!state.collpase3}>
                                            <div className="cm-content-body publish-content form excerpt">
                                                <div className="card-body pb-0">
                                                    <div className="accordion-item">
                                                        <ul className="d-flex align-items-center mb-2">
                                                            <li><Link href={"#"} scroll={false}><i className="fas fa-key"></i></Link></li>
                                                            <li><Link href={"#"} scroll={false} className="ms-2">Status:</Link></li>
                                                            <li><strong><Link href={"#"} scroll={false} className="mx-2">Published</Link></strong></li>
                                                            <li>
                                                                <Link href={"#"} scroll={false} className="accordion accordion-primary"                                                            
                                                    ...
                                                    <div className="accordion-item">
                                                        <ul className="d-flex align-items-center mb-2">
                                                            <li><Link href={"#"} scroll={false}><i className="fa fa-fw fa-eye"></i></Link></li>
                                                            <li><Link href={"#"} scroll={false} className="ms-2">Status:</Link></li>
                                                            <li><strong><Link href={"#"} scroll={false} className="mx-2">Public</Link></strong></li>
                                                            <li>
                                                                <Link href={"#"} scroll={false} className="accordion accordion-primary"                                                                 
                                                    ...
                                                    <div className="accordion-item">
                                                        <ul className="d-flex align-items-center mb-2 flex-wrap">
                                                            <li><Link href={"#"} scroll={false}><i className="fas fa-calendar-alt"></i></Link></li>
                                                            <li><Link href={"#"} scroll={false} className="ms-2">Published</Link></li>
                                                            <li><strong><Link href={"#"} scroll={false} className="mx-2">on :24-09-2022 16:22:52 </Link></strong></li>
                                                            <li><Link href={"#"} scroll={false} className="accordion accordion-primary"                                                                 
                                                ...
                                                <div className="card-footer border-0 text-end py-3 ">
                                                    <Link href={"#"} scroll={false} className="btn btn-primary btn-sm">Publish</Link>
                                                </div>
                                            </div>
                                        </Collapse>
                                    </div>
                                    ...
                                    <Collapse in={!state.collpase4}>
                                        <div className="cm-content-body publish-content form excerpt">
                                            <div className="card-body">
                                                ...
                                                <Link href={"#"} scroll={false}><i className="fas fa-plus"></i> Add New Categories</Link>
                                                <div className="input-group mt-3">
                                                    <input type="text" className="form-control" placeholder="Username"  />
                                                    <span className="input-group-text" id="basic-addon1"><Link href={"#"} scroll={false}>Add New</Link></span>
                                                </div>
                                            </div>											
                                        </div>
                                    </Collapse>
                                                    ...
                                                    <div className="avatar-upload d-flex align-items-center">
                                                        <div className=" position-relative ">
                                                            <div className="avatar-preview">
                                                                <div id="imagePreview" 
                                                                    style={{backgroundImage: file? "url(" + URL.createObjectURL(file) + ")" : "url(" + NoImage.src +")" }}
                                                                >   
                                                                </div>
                                                            </div>
