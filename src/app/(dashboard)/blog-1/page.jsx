                    ...
                    <div className="col-xl-12">
						<div className="card">
							<div className="card-header border-0">
								...
								<Link href="#" scroll={false} className="btn btn-primary btn-sm">More</Link>
							</div>
							<div className="card-body">
								<div className="row">
									<div className="col-xl-6 col-lg-6 col-md-12">
										<div className="blog-img">
											<Image src={IMAGES.Professional} alt="" className="blk-img" />
											<div className="blog-text">
												<h2>This quote highlights the importance of writing clear.</h2>
												<Image src={IMAGES.contact1} className="avatar rounded-circle me-2" alt="" />
										...
										<div className="blog-post">
                                            {postDetial.map((item, index)=>(
                                                <div className="post-1" key={index}>
                                                    <Image src={item.image} className="avatar rounded-circle me-2 custome-avatar" alt="" />
                                                    <div className="post-data">
                                                        <span className={`badge border-0 badge-sm badge-${item.theme}`}>{item.maintitle}</span>
                                                        <h4>{item.subtitle}</h4>
                                                        <div>
                                                            <Image src={item.image2} className="avatar rounded-circle me-2 small-post" alt="" />{" "}
						...
						<div className="row">
							<div className="col-xl-12">
								<div className="card">
									...
									<div className="card-body">
										<div className="blog-img">
											<Image src={IMAGES.Professional2} alt="" className="blk-img2" />
											<div className="blog-text">
												<h2>This quote highlights the importance of writing clear.</h2>
												<Image src={IMAGES.contact2} className="avatar rounded-circle me-2 small-post" alt="" />
												<span>Hary in February 05, 2023</span>
											</div>
										</div>
										<div className="row">
                                ...
                                <div className="third-post style-1" key={ind}>
                                    ...
                                    <div className="post-1">
                                        <div className="post-data">
                                            <h4>{data.title}</h4>
                                            <div className="mb-2">
                                                <Image src={data.image2} className="avatar rounded-circle me-2 small-post" alt="" /> 
								...
								<div className="notify-data">
									...
									<form onClick={(e)=>submitHandle(e)}>
										<div className="mt-3">
										  ...
										  <Link href="#" scroll={false}  className="btn btn-primary btn-sm  d-block mt-3">subscribe</Link>
										</div>
						...
						<div className="recent-post">
                            ...
                            {commentsblog.map((item, ind)=>(
                                <div className="third-post style-2" key={ind}>
                                    <Image src={item.image} className="avatar  rounded-circle me-2 av-post" alt="" />
                                    <div className="post-1">
                                        <div className="post-data">
