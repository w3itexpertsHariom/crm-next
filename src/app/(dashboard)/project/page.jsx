                                ...
                                <div className="card-body">
                                    ...
                                    <div>
                                        ...
                                        <div className="avatar-list avatar-list-stacked">
                                            <Image src={IMAGES.contact6} className="avatar rounded-circle" alt="round" />{" "}
                                            <Image src={IMAGES.contact5} className="avatar rounded-circle" alt="round" />{" "}
                                            <Image src={IMAGES.contact1} className="avatar rounded-circle" alt="round" />{" "}
                                            <Image src={IMAGES.contact5} className="avatar rounded-circle" alt="round" />{" "}
                                            <Image src={IMAGES.contact6} className="avatar rounded-circle" alt="round" />
                                        </div>
                                    </div>
