                ...
                <div className="row">
					<div className="col-xl-12">                        
                        ...
                        <div className="d-flex align-items-center justify-content-between mb-3">
							<span>
								<Link href={"#"} scroll={false} className="btn btn-primary btn-sm">Save Settings</Link>{" "}
								<Link href={"#"} scroll={false} className="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Prompt</Link>
                            </span>
							<Link href={"#"} scroll={false} className="btn-danger btn btn-sm">Reset Prompts</Link>
						</div>
                                                ...
                                                <div className="card-footer">
                                                    ...
                                                    <ul className="promt-langauage">
														{CountryList.map((item, ind)=>(
															<li key={ind}>
																<Link href={"#"} scroll={false} className="btn btn-sm btn-outline-primary mb-1">{item.name}</Link>
															</li>
														))}                                                        
                                                    </ul>
                                                    <div className="my-3">
